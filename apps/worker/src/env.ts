...
export const env = {
  ...
  maxTokensWriterResearchSection: num("MAX_TOKENS_WRITER_RESEARCH_SECTION", 1200),
  maxWriterInputChars: num("MAX_WRITER_INPUT_CHARS", 32000),
  tavilyApiKey: process.env.TAVILY_API_KEY ?? "",
  writerWebSearchMaxResults: num("WRITER_WEB_SEARCH_MAX_RESULTS", 5),
  writerWebSearchMaxQueries: num("WRITER_WEB_SEARCH_MAX_QUERIES", 3),
